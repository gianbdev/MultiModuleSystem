...
import com.cliPos.entity.configuracion.UserEntity;
import com.cliPos.security.jwt.JwtUtil;
...
public class AuthService {
    ...
    @Autowired
    public AuthService(CustomUserServiceDetails customUserServiceDetails, JwtUtil jwtUtil, AuthenticationManagerBuilder authenticationManagerBuilder) {
    ...
    public UserEntity getCurrentUser() {
        ...
        return customUserServiceDetails.findEntityByEmail(email);
    }
    ...
    public static class TokenInvalidatedException extends RuntimeException {
