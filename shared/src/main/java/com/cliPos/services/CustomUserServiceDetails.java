...
import com.cliPos.jpa.configuracion.UserJpaRepository;
import com.cliPos.security.validators.ResourceNotFoundException;
...
public class CustomUserServiceDetails implements UserDetailsService {
    ...
    @Autowired
    public CustomUserServiceDetails(UserJpaRepository userRepository) {
